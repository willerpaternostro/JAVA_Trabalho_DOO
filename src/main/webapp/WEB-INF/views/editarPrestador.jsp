...
<h1 class="col-4 text-center mb-4">Editar Prestador</h1>
</div>
...
<div class="row justify-content-center">
	...
	<input class="col-3 mb-2" type="text" name="documento" value="${documento}">
</div>
<div class="row justify-content-center">
...
<div class="row justify-content-center">
	...
	<input class="col-3 mb-2" type="text" name="servicoOferecido" value="${servicoOferecido}">
</div>
<div class="row justify-content-center">
	<label class="col-1">Valor Diária:</label>
	<input class="col-3 mb-2" type="text" name="valorDiaria" value="${valorDiaria}">
</div>
<div class="row justify-content-center">
	<div class="form-check col-3 offset-1 mb-2">
  <input class="form-check-input" type="checkbox" value="true" ${atendeUrgencia?"checked":""} name="atendeUrgencia" id="atendeUrgencia">
...
<div class="row justify-content-center">
	...
	<input type="hidden"  value="EditarPrestador" name="comando">
</div>
